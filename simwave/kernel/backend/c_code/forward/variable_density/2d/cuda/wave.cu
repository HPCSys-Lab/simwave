...
__global__ void kernel_BoundaryCond_LeftRight(size_t nx, size_t nz,
...
__global__ void kernel_BoundaryCond_TopBottom(size_t nx, size_t nz,
                                              size_t z_before, size_t z_after,
                                              size_t x_before, size_t x_after,
                                              size_t next_t, size_t stencil_radius,
                                              f_type *u)
...
__global__ void kernel_UpdateWavefield(size_t prev_t, size_t current_t, size_t next_t,
                                       ...
                                       f_type *u, f_type *velocity, f_type *density, f_type *coeff_order1, f_type *coeff_order2,
                                       f_type *damp)
{
    // nz --> vertical
    // nx --> horizontal
                          ...
                          size_t space_order, size_t num_snapshots)
{
    ...
    for (size_t n = begin_timestep; n <= end_timestep; n++)
    {
        ...
        */
        ...
        kernel_UpdateWavefield<<<grid, block>>>(prev_t, current_t, next_t,
                                                ...
                                                d_u, d_velocity, d_density,
                                                d_coeff_order1, d_coeff_order2, d_damp);
    ...
    checkErrorCuda(cudaFree(d_density));
